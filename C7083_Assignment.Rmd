...
titl <- "<span style = 'font-weight:bold'>Consumption of Animal Products vs Plant Products and resultant CO2 emmisssions</span><br>
...
ggplot( aes(x = total_con_gp_Animal, y = total_con_gp_Plant ))+
 ...
 # add point to show plant co2 inside total co2
  ...
  theme(legend.position=c(0.8,0.95), # inset legend
        ...
        plot.title = element_markdown(hjust = -.2))+ # allow colour change of title
